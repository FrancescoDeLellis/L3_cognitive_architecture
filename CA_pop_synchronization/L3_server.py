...
class L3_Wrapper():
    ...
    def update_position(self, positions, delta_t, time):
        ...
        self.kuramoto_phases.append(self.l3_agent.update_phases(self.kuramoto_phases[-1]))                  # comment this and uncomment upper line if L3 is connected with VR agents 
